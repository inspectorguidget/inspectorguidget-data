    ...
    stages {
        ...
        stage("github => pending") {
            steps {
                ...
                githubNotify account: 'arnobl',sha: '${commitHash}', status: 'PENDING', description: 'Setting build status', credentialsId: 'ghToken', repo: 'https://github.com/inspectorguidget/inspectorguidget-data'
            }
        }
