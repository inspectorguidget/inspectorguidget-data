    ...
    stages {
        ...
        stage("github => pending") {
            steps {
                ...
                githubNotify account: 'inspectorguidget',sha: '${commitHash}', status: 'PENDING', description: 'Setting build status', credentialsId: 'github-token', repo: 'https://github.com/inspectorguidget/inspectorguidget-data'
            }
        }
